...
public class ConstructionYard extends UniqueStructure {
	
	public static final ConstructionYard INSTANCE = new ConstructionYard();
	...
	protected StructureDef initStructure() {
		return StructureDef.CONSTRUCTION_YARD;		
	}
